...
pacman::p_load(rstudioapi,dplyr, ggplot2, lubridate, randomForest, caret,
               ...
               ggthemes,RMySQL,rhandsontable,data.table,shinyjs,DBI, keyring)
...
rm(user, password, dbname, host, port)
...
ui <- dashboardPage(
 ...
 server <- function(input, output, session) {
   ...
   output$exploring = renderRHandsontable({
      # transform the df into a rhandsontable object
